          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  // Using ValueKey to preserve the state of each item
                  // when the list is reordered.
                  // Could also be: UniqueKey() or ObjectKey(todo)
                  // but ValueKey is more descriptive.
                  // See https://api.flutter.dev/flutter/widgets/ValueKey-class.html
